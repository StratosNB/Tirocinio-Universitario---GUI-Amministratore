package admingui.views.attributes.object_enviroment;
...
public class ObjectEnviromentAttributesPanel {
	...
	public ObjectEnviromentAttributesPanel() {
		initComponents();
	}
	...
	protected void initTables() {
		objectFixedAttributesTable = new JTable(AdminGuiComponentsConstants.OBJECTS_FIXED_ATTRIBUTES_TABLE_DATA,
