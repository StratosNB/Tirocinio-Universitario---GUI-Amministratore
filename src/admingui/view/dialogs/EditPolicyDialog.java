...
public class EditPolicyDialog {
	...
	protected void initMainDialog() {
		...
		mainDialog.setTitle("Edit Access Control Policy");
	...
	protected void setActionCommands() {
		...
		validate.setActionCommand("VALIDATE EXP PREDICATE");
	...
	protected CompletionProvider createCompletionProvider(List<Attribute> attributes,
		...
		/*
		 * attributes.forEach(attribute -> provider.addCompletion(new
		 * BasicCompletion(provider, attribute.getName())));
		 * functions.forEach(function -> provider.addCompletion(new
		 * BasicCompletion(provider, function.getName())));
		 */
