...
public class AttributesPanel {
	...
	protected void initTables() {
		userFixedAttributesTable = new JTable(AdminGuiConstants.USERS_FIXED_ATTRIBUTES_TABLE_DATA,
				AdminGuiConstants.FIXED_ATTRIBUTES_TABLE_COLUMNS);
		userFixedAttributesTable.setFillsViewportHeight(true);
		clientFixedAttributesTable = new JTable(AdminGuiConstants.CLIENTS_FIXED_ATTRIBUTES_TABLE_DATA,
				AdminGuiConstants.FIXED_ATTRIBUTES_TABLE_COLUMNS);
